...
class MY_Controller extends CI_Controller {
	...
	function __construct() {
		parent::__construct ();
		$this->area_mod = $this->uri->segment(1);
	...
	public function especialidade(){
		...
		$this->load->model('RunModel', 'model');
		$data['especialidade_list'] = $this->model->especialidade();
		$html = $this->load->view('modules/Especialidade_Form', $data, true);
		$this->show($html);
	}
	...
	public function atuacao(){
		...
		$this->load->model('RunModel', 'model');
		$data['atuacao_list'] = $this->model->atuacao();
		$html = $this->load->view('modules/atuacao_form', $data, true);
		$this->show($html);
	}
}
